Day 21: In the GitHub repository, Infinity-AI(Infinite Learn and Grow)/30-days-code inside the Day-21 folder create your_name.py file as defined in the readme.md file.
