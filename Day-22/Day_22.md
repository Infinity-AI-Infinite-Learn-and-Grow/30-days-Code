Day 22: In the GitHub repository, Infinity-AI(Infinite Learn and Grow)/30-days-code inside the Day-22 folder create your_name.py file as defined in the readme.md file.
